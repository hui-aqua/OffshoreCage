...
num_p=num_seg*2+1
for j in range(4):
    for i in range(round(num_seg-1-int(num_seg*0.9090),0)):
    ...
    for i in range(round(num_seg-2-int(num_seg*0.9090),0)):
        mooring_line_fiber.append([2*num_seg-i+num_p*j,2*num_seg-1-i+num_p*j])

mooring_line_chain=[]
for j in range(4):
    for i in range(1+round(int(num_seg*0.9090),0)):
...
mass_mooring_line_new =[147*mooring_length/num_seg/2]
mass_mooring_line_new+=[147*mooring_length/num_seg]*round(int(num_seg*0.9090),0)
mass_mooring_line_new+=[147*mooring_length/num_seg/2 + 4*mooring_length/num_seg/2]
mass_mooring_line_new+=[4*mooring_length/num_seg]*round(num_seg-1-int(num_seg*0.9090),0)
mass_mooring_line_new+=[147*mooring_length/num_seg/2]
mass_mooring_line_new+=[147*mooring_length/num_seg]*round(int(num_seg*0.9090),0)
mass_mooring_line_new+=[147*mooring_length/num_seg/2 + 4*mooring_length/num_seg/2]
mass_mooring_line_new+=[4*mooring_length/num_seg]*round(num_seg-2-int(num_seg*0.9090),0)
